            ...
            <div className="space-y-2">
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value={ExpenseCategory.SALARY}>Salarios</SelectItem>
                  <SelectItem value={ExpenseCategory.UTILITIES}>Servicios Públicos</SelectItem>
                  <SelectItem value={ExpenseCategory.RENT}>Rentas</SelectItem>
                  <SelectItem value={ExpenseCategory.OTHER}>Otro</SelectItem>
                </SelectContent>
              </Select>
            </div>
